...
[**Live Demo (DuckDNS)**](http://shield-gateway.duckdns.org:3000/) • [**Swagger API Docs**](http://shield-gateway.duckdns.org:8000/docs) • [**Architecture Specs**](./architecture_diagrams.md)
